...
public class Values extends ArrayList<Value<?>> implements Encodable {
  ...
  public void add (final int index, final String element) {
    this.add(index, element, this.encode);
  }
   ...
   */
  public void add (final int index, final String element,
      @SuppressWarnings ("hiding") final boolean encode) {
  ...
  public boolean add (final String element) {
    return this.add(element, this.encode);
  }
   ...
   * @see java.util.ArrayList#add(java.lang.Object)
   */
  public boolean add (final String element, @SuppressWarnings ("hiding") final boolean encode) {
    final Value<String> v = new Value<String>(element);
    v.setEncode(encode);
    return this.add(v);
  }
