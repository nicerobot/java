...
public class Indent {
   ...
   */
  public Indent (final Indentable toformat,
      @SuppressWarnings ("hiding") final boolean finalDelimiter) {
  ...
  public Indent (final LineIterable toformat,
      @SuppressWarnings ("hiding") final boolean finalDelimiter, final String... strings) {
   ...
   */
  public void setDelimiter (@SuppressWarnings ("hiding") final String delimiter) {
   ...
   */
  public void setEndString (@SuppressWarnings ("hiding") final String endString) {
   ...
   */
  public void setStartString (@SuppressWarnings ("hiding") final String startString) {
