...
/**
 * If a text or markdown file is requested and text/html is requested as the content-type, transform
 * it to html using http://code.google.com/p/markdownj/.
 * 
 * @author nicerobot
 * 
 */
public class Markup implements Filter {
